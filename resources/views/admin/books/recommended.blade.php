...
@section('title', 'Recommended Books List')
@push('css')
                                    ...
                                    <span class="svg-icon svg-icon-2">
                                                    <svg width="24" height="24"
                                                        ...
                                                        <rect x="4.36396" y="11.364" width="16" height="2" rx="1"
                                                              fill="currentColor"/></svg></span>Add Recommended Books
                                </button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
    ...
    <script>
        $(document).ready(function () {
            $('#table').DataTable({
                ...
                'serverSide': true,
                'ajax': {
                    'url': "{{ route('admin.recommended_book.index') }}",
                    'dataType': 'json',
                    'type': 'GET',
                    'data': {
                        _token: "{{csrf_token()}}",
            ...
            $('#add_form').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{route('admin.recommended_book.store')}}',
