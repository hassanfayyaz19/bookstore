      ...
      fill="currentColor"/>
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                         ...
                         data-kt-menu-placement="bottom-end">
                        <img src="{{isset($project_setting->profile)?asset($project_setting->profile):''}}" alt="user"/>
                    </div>
                    ...
                    <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo"
                                         src="{{isset($project_setting->profile)?asset($project_setting->profile):''}}"/>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <div class="menu-item px-5">
                            <a href="javascript:"
                               onclick="document.getElementById('logout-form').submit();" class="menu-link px-5">
                                Sign Out
                            </a>
