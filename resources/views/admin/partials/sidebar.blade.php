    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        >
            ...
            >
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item menu-accordion
                 {{request()->route()->getName()=='admin.blog_category.index' ? 'show' : ''}}
                         ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{request()->route()->getName()=='admin.blog_category.index'?'active':''}}"
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item menu-accordion
                 {{request()->route()->getName()=='admin.book_review.index' ? 'show' : ''}}
                         ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{request()->route()->getName()=='admin.book_review.index'?'active':''}}"
                               href="{{route('admin.book_review.index')}}">
                                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                    class="menu-title">List</span></a>
                        </div>
                    </div>
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item menu-accordion
                 {{request()->route()->getName()=='admin.user_subscription.index' ? 'show' : ''}}
                 ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                        ...
                        <span class="menu-title">User Subscription</span>
                        <span class="menu-arrow"></span>
                    </span>

                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{request()->route()->getName()=='admin.user_subscription.index'?'active':''}}"
                               href="{{route('admin.user_subscription.index')}}">
                                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span
                                    class="menu-title">List</span></a>
                        </div>
                    </div>
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item menu-accordion
                 {{request()->route()->getName()=='admin.project_setting.index' ? 'show' : ''}}
                 ">
                    <span class="menu-link">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{request()->route()->getName()=='admin.project_setting.index'?'active':''}}"
