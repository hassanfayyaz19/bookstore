                            ...
                            <div class="col-md-6">
                                <div class="swiper-content">
                                    <div class="content-info">
                                        ...
                                        <p class="text mb-0" data-swiper-parallax="-40">It is a long established
                                        ...
                                        <div class="content-btn" data-swiper-parallax="-60">
                                            <a class="btn btn-primary btnhover" href="books-grid-view.html">Buy
                                                Now</a>
                            ...
                            <div class="col-md-6">
                                <div class="swiper-content">
                                    <div class="content-info">
                                        ...
                                        <p class="text mb-0" data-swiper-parallax="-40">Lorem ipsum dolor sit
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="books-card">
                    <div class="dz-media">
                        <img src="{{asset('user/images/books/book16.png')}}" alt="book">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="books-card">
                    <div class="dz-media">
                        <img src="{{asset('user/images/books/grid/book9.jpg')}}" alt="book">
                    </div>
                    <div class="dz-content">
